...
document
  .getElementById("linkOperazioni100")
  .addEventListener("click", function (e) {
    e.preventDefault(); // Evita la navigazione normale
    loadPage("html/operazioniEntroil100.htm", "js/operazioniEntroil100.js"); // Carica la pagina operazioni.html e il relativo script
  });
